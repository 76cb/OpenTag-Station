...
class TrackingMemory final:public services::ICommunityCatalogMemory {
 public:
  ...
  std::vector<Allocation> allocations;unsigned internal_allocations{},external_allocations{},internal_releases{},external_releases{};bool fail_internal{},fail_external{},misclassify_internal{},heap_valid{true};mutable unsigned heap_checks{};mutable std::uint32_t clock{};
};
