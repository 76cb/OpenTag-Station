...
Archived pre-1.0 engineering changelog. Old build commands and distribution descriptions are historical, not installation instructions. Install normal OpenTag Station.
