...
using opentag::nfc::nfcv::NfcvSystemInformation;
using opentag::nfc::nfcv::ReadResponseResult;
using opentag::nfc::nfcv::format_diagnostic_uid;
using opentag::nfc::nfcv::parse_nfcv_system_information;
using opentag::nfc::nfcv::copy_nfcv_read_response;
using opentag::nfc::nfcv::diagnostic_checksum;
using opentag::nfc::nfcv::format_diagnostic_checksum;
