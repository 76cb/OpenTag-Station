...
inline constexpr std::size_t maximum_index_html_bytes = 20U * 1024U;
inline constexpr std::size_t maximum_stylesheet_bytes = 24U * 1024U;
inline constexpr std::size_t maximum_javascript_bytes = 72U * 1024U;
inline constexpr std::size_t maximum_total_source_bytes = 104U * 1024U;
