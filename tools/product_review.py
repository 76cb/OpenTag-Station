...
A.state.printers=[{id:'prusa-xl',display_name:"Casy's Prusa XL",state:'idle',revision:7,toolheads:Array.from({length:5},(_,i)=>({backend_id:i,assigned_spool_id:i===1?27:i===3?31:null}))}];
...
def main():
    ...
    page=args.output/'index.html';page.write_text(harness.fixture(page),encoding='utf-8')
