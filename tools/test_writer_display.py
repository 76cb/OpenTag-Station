...
let communityMode='success',communityRelease;const communityRow={id:'brand-pla',name:'Community PLA',manufacturer:'Brand',material:'PLA',density:1.24,diameter:1.75,weight:1000,spool_weight:130};
...
if(body.action==='import_preview')result={phase:'import_preview',import_token:'fixture-import',vendor_name:'Brand',proposed_filament:communityRow};
